...
class ProductsController extends Controller
{
    ...
    {   
        $brands = DB::table('brands')->orderBy('name')->get();
        return view("products.detail", compact('brands'));
    }
    ...
    {
        return view("products.appliance");
    }
    ...
    public function product(Aswo $aswo, $type, $model, $product_id, $family_name, $family_id)
    {
        ...
        if($product = \App\Product::where('aswo_id', $product_detail['artikelnummer'])->first())
        {
            // Modify fields in $article_appliance
            $product_detail["final_price"] = $product->price;
            $product_detail["artikelbezeichnung"] = $product->name;
        }
        ...
        return view("products.product1", array(
    ...
    public function singleProduct(Aswo $aswo, $model, $product_id)
    {
        ...
        $delivery_date = "Sur commande";
        if(isset($product_detail['lieferzeit_in_tagen'])) {
            $delivery_date = $this->get_delivery_date($product_detail['lieferzeit_in_tagen']);
        }
