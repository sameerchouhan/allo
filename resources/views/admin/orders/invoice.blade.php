<!DOCTYPE html>
    ...
    <body>
        ...
        <button style="margin: 20px;" class="btn-print-invoice" onclick="print_invoice()">Imprimer la facture</button>
        ...
        <div style="padding: 0 30px; padding-top: 65px; height: 160px; font-size: 13px; line-height: 1.2; text-align: left; padding-left: 80px;">
            ...
            {{ $t->shipping_zip }} {{ $t->shipping_city }}<br>
            {{ $t->shipping_country }}
        </div>
        ...
        <div style="padding: 0 30px; padding-top: 10px;">
            ...
            <div style="float: right; text-transform: uppercase; text-align: right;">
            ...
            <table style="margin: auto; margin-top: 30px; width: 50%; float: right;">
                ...
                <tbody style="text-align: right;">
                    ...
                    <tr>
                        ...
                        @if (($t -> shipping_country) === "France")
                                        {{ my_format(($t->total_products + $t->total_shipping)) }}€
                                    
                        @else
                        
                                        {{ my_format(($t->total_products + $t->total_shipping + 2)) }}€
                        @endif
