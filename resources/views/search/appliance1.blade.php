                            ...
                            <div class="block-content">
                                <div class="filter-options-item filter-categori">
                                    ...
                                    <div class="filter-options-content">
                                        <ul>
                                            <?php 
                                                //print_r($article_families); 
                                                //echo str_slug($type, '-');//aspirateur-sans-sac
                                                //echo str_slug($model, '-');//dyson
                                                //echo str_slug($appliance_id, '-');//1052711 
                                                    
                                            ?>
                                            @foreach($article_families as $family)
                                                <?php 
                                                    //echo $family['vgruppenid'];//4151000000
                                                    //echo str_slug($family['vgruppenname'], '-');//ac-moteurs
                                                ?>
                                            <li>
                                                <label class="inline">
