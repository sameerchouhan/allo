                                ...
                                <div class="filter-options-item filter-categori">
                                    ...
                                    <div class="filter-options-content">
                                        <ul>
                                            ...
                                            <li>
                                                <label class="inline">
                                                    <input class="getfilter" type="checkbox" value="<?=$family['vgruppenid'].'_'.str_slug($appliance_id, '-').'_'.str_slug($model, '-').'_'.str_slug($type, '-').'_'.str_slug($family['vgruppenname'], '-');?>" name="cat[]" id="<?php echo str_slug($appliance_id, '-');?>" >
