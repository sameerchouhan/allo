                        ...
                        <table border="0" cellpadding="5" cellspacing="0" width="100%" id="emailBody">
                            <tr>
                                <td align="left" valign="top" style="font-family:arial;font-size:14px;color:#000;">
                                    Merci, nous traitons votre commande. Les détails de la commande sont ci-dessous.<br /><br />Merci de bien vouloir envoyer votre chèque à:<br /><br />Silver Stone Monaco,<br />« Service Comptabilité »<br />48 Boulevard du Jardin Exotique,<br />98000, Monte Carlo.
                                </td>
                            </tr>
                        </table>
                    </td>
